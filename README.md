...
Originally, I had written this program in Python, but it was a resource hog, so it was ported over to Rust. MyMIDI was written for the Akai MPK Mini Play and must be adapted for your device.
